...
// =======================================
function requireSelfAlunoOrRoles(...regras) {
  return (req, res, next) => {
    ...
    const hasRole = req.user && regras.includes(req.user.regras);
